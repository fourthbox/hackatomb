...
public:    
    ...
    inline std::pair<size_t, size_t> GetPosition() const { return map_location_.GetPosition(); }
    inline MapLocation const &GetMapLocation() const { return map_location_; }
    
protected:
    MapLocation map_location_;
